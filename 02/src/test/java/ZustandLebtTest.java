...
public class ZustandLebtTest {
  ...
  private Zustand erzeugeTestObject() {
    Zustand zustand = new ZustandLebt(zustandZaehler);
    return zustand;
  }
